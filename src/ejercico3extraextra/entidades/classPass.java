...
Ejercicio
 */
package ejercico3extraextra.entidades;
...
public class classPass {
    ...
    public classPass(String pass) {
        this.pass = pass;
    }

    public classPass(String nombre, String dni) {
        this.nombre = nombre;
        this.dni = dni;
    }
   
    
    public classPass(String pass, String nombre, String dni) {
        this.pass = pass;
        this.nombre = nombre;
        this.dni = dni;
    }
